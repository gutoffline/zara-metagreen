...
* [[Doc] Plugin Demo](https://marketplace.codieslab.com/shop/)
...
== Changelog ==
= 1.0.4 =
* Resolved  CSS bug fix
* Remove widget area
* Fix Php error warning
* compatible with Woocommerce version 4.3.2
* Fix Un define variable errors
