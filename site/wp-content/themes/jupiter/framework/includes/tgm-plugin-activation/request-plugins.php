...
function mk_jupiter_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name' => __( 'WPBakery Page Builder (Modified Version)', 'mk_framework' ),
			'slug' => 'js_composer_theme',
			'source' => 'https://static.artbees.net/plugins/js_composer_theme.6.0.5.zip',
			'required' => true,
			'version' => '6.0.5',
		...
		array(
			'name' => __( 'Jupiter Donut', 'mk_framework' ),
			'slug' => 'jupiter-donut',
			'source' => 'https://static.artbees.net/plugins/jupiter-donut.1.0.2.zip',
			'required' => true,
			'version' => '1.0.2',
			'force_activation' => false,
			'force_deactivation' => false,
